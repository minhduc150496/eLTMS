...
var homeController = {
    init: function () {
        ...
        document.getElementById("txtSearchDate").value = dateNow;
        homeController.loadDataLabTestingAddDate(true);        
    ...
    registerEvent: function () {
        ...
        $('.btn-changeLabtestingStatus').off('click').on('click', function () {
            var id = $(this).data('id');       
            $.ajax({
