...
//     Connection String:      "data source=DUCBMSE61791;initial catalog=eLTMS-draft04;User ID=sa;password=**zapped**;"
// ------------------------------------------------------------------------------------------------
...
namespace eLTMS.DataAccess.Models
{
    ...
    public class TestProfileLabTestMapping
    {
        ...
        [Index(@"PK__TestProf__9023CE1CBA227D94", 1, IsUnique = true, IsClustered = true)]
        [Required]
        [Key]
        ...
        /// <summary>
        /// Parent LabTest pointed by [TestProfileLabTestMapping].([LabTestId]) (FK__TestProfi__LabTe__0D7A0286)
        /// </summary>
        [ForeignKey("LabTestId")] public virtual LabTest LabTest { get; set; } // FK__TestProfi__LabTe__0D7A0286

        /// <summary>
        /// Parent TestProfile pointed by [TestProfileLabTestMapping].([TestProfileId]) (FK__TestProfi__TestP__0E6E26BF)
        /// </summary>
        [ForeignKey("TestProfileId")] public virtual TestProfile TestProfile { get; set; } // FK__TestProfi__TestP__0E6E26BF
    ...
    public class TestProfile
    {
        ...
        [Index(@"PK__TestProf__2373011CB4199F2B", 1, IsUnique = true, IsClustered = true)]
        [Required]
        [Key]
        [Display(Name = "Test profile ID")]
        ...
        /// <summary>
        /// Child TestProfiles where [TestProfile].[ParentProfileID] point to this entity (FK__TestProfi__Paren__0C85DE4D)
        /// </summary>
        public virtual System.Collections.Generic.ICollection<TestProfile> TestProfiles { get; set; } // TestProfile.FK__TestProfi__Paren__0C85DE4D
        /// <summary>
        /// Child TestProfileLabTestMappings where [TestProfileLabTestMapping].[TestProfileID] point to this entity (FK__TestProfi__TestP__0E6E26BF)
        /// </summary>
        public virtual System.Collections.Generic.ICollection<TestProfileLabTestMapping> TestProfileLabTestMappings { get; set; } // TestProfileLabTestMapping.FK__TestProfi__TestP__0E6E26BF

        // Foreign keys

        /// <summary>
        /// Parent TestProfile pointed by [TestProfile].([ParentProfileId]) (FK__TestProfi__Paren__0C85DE4D)
        /// </summary>
        [ForeignKey("ParentProfileId")] public virtual TestProfile ParentProfile { get; set; } // FK__TestProfi__Paren__0C85DE4D
    ...
    public class LabTest
    {
        ...
        /// <summary>
        /// Child TestProfileLabTestMappings where [TestProfileLabTestMapping].[LabTestID] point to this entity (FK__TestProfi__LabTe__0D7A0286)
        /// </summary>
        public virtual System.Collections.Generic.ICollection<TestProfileLabTestMapping> TestProfileLabTestMappings { get; set; } // TestProfileLabTestMapping.FK__TestProfi__LabTe__0D7A0286
    ...
    public class HospitalFacultyMapping
    {
        ...
        [Index(@"PK__Hospital__275680DE5E7E960F", 1, IsUnique = true, IsClustered = true)]
        [Required]
        [Key]
        ...
        /// <summary>
        /// Parent Faculty pointed by [HospitalFacultyMapping].([FacultyId]) (FK__HospitalF__Facul__7D439ABD)
        /// </summary>
        [ForeignKey("FacultyId")] public virtual Faculty Faculty { get; set; } // FK__HospitalF__Facul__7D439ABD

        /// <summary>
        /// Parent Hospital pointed by [HospitalFacultyMapping].([HospitalId]) (FK__HospitalF__Hospi__7E37BEF6)
        /// </summary>
        [ForeignKey("HospitalId")] public virtual Hospital Hospital { get; set; } // FK__HospitalF__Hospi__7E37BEF6
    ...
    public class Hospital
    {
        ...
        [Index(@"PK__Hospital__38C2E58F8C7FE5AD", 1, IsUnique = true, IsClustered = true)]
        [Required]
        [Key]
        [Display(Name = "Hospital ID")]
        ...
        /// <summary>
        /// Child HospitalFacultyMappings where [HospitalFacultyMapping].[HospitalID] point to this entity (FK__HospitalF__Hospi__7E37BEF6)
        /// </summary>
        public virtual System.Collections.Generic.ICollection<HospitalFacultyMapping> HospitalFacultyMappings { get; set; } // HospitalFacultyMapping.FK__HospitalF__Hospi__7E37BEF6
        /// <summary>
    ...
    public class Feedback
    {
        ...
        [Index(@"PK__Feedback__6A4BEDF690F71556", 1, IsUnique = true, IsClustered = true)]
        [Required]
        [Key]
        ...
        /// <summary>
        /// Parent Employee pointed by [Feedback].([EmployeeId]) (FK__Feedback__Employ__7B5B524B)
        /// </summary>
        [ForeignKey("EmployeeId")] public virtual Employee Employee { get; set; } // FK__Feedback__Employ__7B5B524B
    ...
    public class Faculty
    {
        ...
        [Index(@"PK__Faculty__306F636EBF060BF4", 1, IsUnique = true, IsClustered = true)]
        [Required]
        [Key]
        [Display(Name = "Faculty ID")]
        ...
        /// <summary>
        /// Child HospitalFacultyMappings where [HospitalFacultyMapping].[FacultyID] point to this entity (FK__HospitalF__Facul__7D439ABD)
        /// </summary>
        public virtual System.Collections.Generic.ICollection<HospitalFacultyMapping> HospitalFacultyMappings { get; set; } // HospitalFacultyMapping.FK__HospitalF__Facul__7D439ABD
        /// <summary>
    ...
    public class Employee
    {
        ...
        [Index(@"PK__Employee__7AD04FF1729F4F5B", 1, IsUnique = true, IsClustered = true)]
        [Required]
        [Key]
        [Display(Name = "Employee ID")]
        ...
        /// <summary>
        /// Child Feedbacks where [Feedback].[EmployeeID] point to this entity (FK__Feedback__Employ__7B5B524B)
        /// </summary>
        public virtual System.Collections.Generic.ICollection<Feedback> Feedbacks { get; set; } // Feedback.FK__Feedback__Employ__7B5B524B
