...
namespace eLTMS.DataAccess.Models
{
    ...
    public class TestProfileLabTestMapping
    {
        ...
        [Index(@"PK__TestProf__9023CE1C5499DDE7", 1, IsUnique = true, IsClustered = true)]
        [Required]
        [Key]
        ...
        /// <summary>
        /// Parent TestProfile pointed by [TestProfileLabTestMapping].([TestProfileId]) (FK__TestProfi__TestP__2739D489)
        /// </summary>
        [ForeignKey("TestProfileId")] public virtual TestProfile TestProfile { get; set; } // FK__TestProfi__TestP__2739D489
    ...
    public class TestProfile
    {
        ...
        [Index(@"PK__TestProf__2373011C67755FDA", 1, IsUnique = true, IsClustered = true)]
        [Required]
        [Key]
        [Display(Name = "Test profile ID")]
        ...
        /// <summary>
        /// Child TestProfiles where [TestProfile].[ParentProfileID] point to this entity (FK__TestProfi__Paren__25518C17)
        /// </summary>
        public virtual System.Collections.Generic.ICollection<TestProfile> TestProfiles { get; set; } // TestProfile.FK__TestProfi__Paren__25518C17
        /// <summary>
        /// Child TestProfileLabTestMappings where [TestProfileLabTestMapping].[TestProfileID] point to this entity (FK__TestProfi__TestP__2739D489)
        /// </summary>
        public virtual System.Collections.Generic.ICollection<TestProfileLabTestMapping> TestProfileLabTestMappings { get; set; } // TestProfileLabTestMapping.FK__TestProfi__TestP__2739D489

        // Foreign keys

        /// <summary>
        /// Parent TestProfile pointed by [TestProfile].([ParentProfileId]) (FK__TestProfi__Paren__25518C17)
        /// </summary>
        [ForeignKey("ParentProfileId")] public virtual TestProfile ParentProfile { get; set; } // FK__TestProfi__Paren__25518C17
    ...
    public class HospitalFacultyMapping
    {
        ...
        [Index(@"PK__Hospital__275680DEA5980F55", 1, IsUnique = true, IsClustered = true)]
        [Required]
        [Key]
        ...
        /// <summary>
        /// Parent Faculty pointed by [HospitalFacultyMapping].([FacultyId]) (FK__HospitalF__Facul__17036CC0)
        /// </summary>
        [ForeignKey("FacultyId")] public virtual Faculty Faculty { get; set; } // FK__HospitalF__Facul__17036CC0

        /// <summary>
        /// Parent Hospital pointed by [HospitalFacultyMapping].([HospitalId]) (FK__HospitalF__Hospi__17F790F9)
        /// </summary>
        [ForeignKey("HospitalId")] public virtual Hospital Hospital { get; set; } // FK__HospitalF__Hospi__17F790F9
    ...
    public class Hospital
    {
        ...
        [Index(@"PK__Hospital__38C2E58F8E03F42A", 1, IsUnique = true, IsClustered = true)]
        [Required]
        [Key]
        [Display(Name = "Hospital ID")]
        ...
        /// <summary>
        /// Child HospitalFacultyMappings where [HospitalFacultyMapping].[HospitalID] point to this entity (FK__HospitalF__Hospi__17F790F9)
        /// </summary>
        public virtual System.Collections.Generic.ICollection<HospitalFacultyMapping> HospitalFacultyMappings { get; set; } // HospitalFacultyMapping.FK__HospitalF__Hospi__17F790F9
        /// <summary>
    ...
    public class Feedback
    {
        ...
        [Index(@"PK__Feedback__6A4BEDF65BD50EC9", 1, IsUnique = true, IsClustered = true)]
        [Required]
        [Key]
        ...
        /// <summary>
        /// Parent Employee pointed by [Feedback].([EmployeeId]) (FK__Feedback__Employ__151B244E)
        /// </summary>
        [ForeignKey("EmployeeId")] public virtual Employee Employee { get; set; } // FK__Feedback__Employ__151B244E
    ...
    public class Faculty
    {
        ...
        [Index(@"PK__Faculty__306F636E56B1E7EF", 1, IsUnique = true, IsClustered = true)]
        [Required]
        [Key]
        [Display(Name = "Faculty ID")]
        ...
        /// <summary>
        /// Child HospitalFacultyMappings where [HospitalFacultyMapping].[FacultyID] point to this entity (FK__HospitalF__Facul__17036CC0)
        /// </summary>
        public virtual System.Collections.Generic.ICollection<HospitalFacultyMapping> HospitalFacultyMappings { get; set; } // HospitalFacultyMapping.FK__HospitalF__Facul__17036CC0
        /// <summary>
    ...
    public class Employee
    {
        ...
        [Index(@"PK__Employee__7AD04FF164B2E653", 1, IsUnique = true, IsClustered = true)]
        [Required]
        [Key]
        [Display(Name = "Employee ID")]
        ...
        /// <summary>
        /// Child Feedbacks where [Feedback].[EmployeeID] point to this entity (FK__Feedback__Employ__151B244E)
        /// </summary>
        public virtual System.Collections.Generic.ICollection<Feedback> Feedbacks { get; set; } // Feedback.FK__Feedback__Employ__151B244E
