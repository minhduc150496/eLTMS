...
//     Connection String:      "Data Source=DUCBMSE61791;Initial Catalog=eLTMS-v3;User ID=sa;password=**zapped**;"
// ------------------------------------------------------------------------------------------------
...
namespace eLTMS.DataAccess.Models
{
    ...
    public class HospitalFacultyMapping
    {
        ...
        [Index(@"PK__Hospital__275680DE97BDA2B8", 1, IsUnique = true, IsClustered = true)]
        [Required]
        [Key]
