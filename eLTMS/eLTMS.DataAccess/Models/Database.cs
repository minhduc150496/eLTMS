...
//     Connection String:      "Data Source=tcp:ducbm.database.windows.net,1433;Initial Catalog=eLTMS-v2;User ID=ducbm;password=**zapped**;"
// ------------------------------------------------------------------------------------------------
...
namespace eLTMS.DataAccess.Models
{
    ...
    public class TestProfileLabTestMapping
    {
        ...
        [Index(@"PK__TestProf__9023CE1CA0C688CD", 1, IsUnique = true, IsClustered = true)]
        [Required]
        [Key]
        ...
        /// <summary>
        /// Parent LabTest pointed by [TestProfileLabTestMapping].([LabTestId]) (FK__TestProfi__LabTe__2FCF1A8A)
        /// </summary>
        [ForeignKey("LabTestId")] public virtual LabTest LabTest { get; set; } // FK__TestProfi__LabTe__2FCF1A8A

        /// <summary>
        /// Parent TestProfile pointed by [TestProfileLabTestMapping].([TestProfileId]) (FK__TestProfi__TestP__30C33EC3)
        /// </summary>
        [ForeignKey("TestProfileId")] public virtual TestProfile TestProfile { get; set; } // FK__TestProfi__TestP__30C33EC3
    ...
    public class TestProfile
    {
        ...
        [Index(@"PK__TestProf__2373011C0F52B518", 1, IsUnique = true, IsClustered = true)]
        [Required]
        [Key]
        [Display(Name = "Test profile ID")]
        ...
        /// <summary>
        /// Child TestProfiles where [TestProfile].[ParentProfileID] point to this entity (FK__TestProfi__Paren__2EDAF651)
        /// </summary>
        public virtual System.Collections.Generic.ICollection<TestProfile> TestProfiles { get; set; } // TestProfile.FK__TestProfi__Paren__2EDAF651
        /// <summary>
        /// Child TestProfileLabTestMappings where [TestProfileLabTestMapping].[TestProfileID] point to this entity (FK__TestProfi__TestP__30C33EC3)
        /// </summary>
        public virtual System.Collections.Generic.ICollection<TestProfileLabTestMapping> TestProfileLabTestMappings { get; set; } // TestProfileLabTestMapping.FK__TestProfi__TestP__30C33EC3

        // Foreign keys

        /// <summary>
        /// Parent TestProfile pointed by [TestProfile].([ParentProfileId]) (FK__TestProfi__Paren__2EDAF651)
        /// </summary>
        [ForeignKey("ParentProfileId")] public virtual TestProfile ParentProfile { get; set; } // FK__TestProfi__Paren__2EDAF651
    ...
    public class LabTest
    {
        ...
        /// <summary>
        /// Child TestProfileLabTestMappings where [TestProfileLabTestMapping].[LabTestID] point to this entity (FK__TestProfi__LabTe__2FCF1A8A)
        /// </summary>
        public virtual System.Collections.Generic.ICollection<TestProfileLabTestMapping> TestProfileLabTestMappings { get; set; } // TestProfileLabTestMapping.FK__TestProfi__LabTe__2FCF1A8A
    ...
    public class HospitalFacultyMapping
    {
        ...
        [Index(@"PK__Hospital__275680DE5A413B7A", 1, IsUnique = true, IsClustered = true)]
        [Required]
        [Key]
        ...
        /// <summary>
        /// Parent Faculty pointed by [HospitalFacultyMapping].([FacultyId]) (FK__HospitalF__Facul__208CD6FA)
        /// </summary>
        [ForeignKey("FacultyId")] public virtual Faculty Faculty { get; set; } // FK__HospitalF__Facul__208CD6FA

        /// <summary>
        /// Parent Hospital pointed by [HospitalFacultyMapping].([HospitalId]) (FK__HospitalF__Hospi__2180FB33)
        /// </summary>
        [ForeignKey("HospitalId")] public virtual Hospital Hospital { get; set; } // FK__HospitalF__Hospi__2180FB33
    ...
    public class Hospital
    {
        ...
        [Index(@"PK__Hospital__38C2E58F7D9409D5", 1, IsUnique = true, IsClustered = true)]
        [Required]
        [Key]
        [Display(Name = "Hospital ID")]
        ...
        /// <summary>
        /// Child HospitalFacultyMappings where [HospitalFacultyMapping].[HospitalID] point to this entity (FK__HospitalF__Hospi__2180FB33)
        /// </summary>
        public virtual System.Collections.Generic.ICollection<HospitalFacultyMapping> HospitalFacultyMappings { get; set; } // HospitalFacultyMapping.FK__HospitalF__Hospi__2180FB33
        /// <summary>
    ...
    public class Feedback
    {
        ...
        [Index(@"PK__Feedback__6A4BEDF6ED725EF7", 1, IsUnique = true, IsClustered = true)]
        [Required]
        [Key]
        ...
        /// <summary>
        /// Parent Employee pointed by [Feedback].([EmployeeId]) (FK__Feedback__Employ__1EA48E88)
        /// </summary>
        [ForeignKey("EmployeeId")] public virtual Employee Employee { get; set; } // FK__Feedback__Employ__1EA48E88
    ...
    public class Faculty
    {
        ...
        [Index(@"PK__Faculty__306F636E24DA2C5C", 1, IsUnique = true, IsClustered = true)]
        [Required]
        [Key]
        [Display(Name = "Faculty ID")]
        ...
        /// <summary>
        /// Child HospitalFacultyMappings where [HospitalFacultyMapping].[FacultyID] point to this entity (FK__HospitalF__Facul__208CD6FA)
        /// </summary>
        public virtual System.Collections.Generic.ICollection<HospitalFacultyMapping> HospitalFacultyMappings { get; set; } // HospitalFacultyMapping.FK__HospitalF__Facul__208CD6FA
        /// <summary>
    ...
    public class Employee
    {
        ...
        [Index(@"PK__Employee__7AD04FF13663E10A", 1, IsUnique = true, IsClustered = true)]
        [Required]
        [Key]
        [Display(Name = "Employee ID")]
        ...
        /// <summary>
        /// Child Feedbacks where [Feedback].[EmployeeID] point to this entity (FK__Feedback__Employ__1EA48E88)
        /// </summary>
        public virtual System.Collections.Generic.ICollection<Feedback> Feedbacks { get; set; } // Feedback.FK__Feedback__Employ__1EA48E88
